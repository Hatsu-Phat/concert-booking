...
CREATE TABLE SUATDIEN(
    ...
    MaSuatDien      VARCHAR2(10) UNIQUE NOT NULL,
    ...
    CONSTRAINT CK_TG_SD CHECK(ThoiGianBatDau < ThoiGianKetThuc)
);

CREATE TABLE NHATAITRO (
    MaNhaTTNum   NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    MaNhaTT      VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE KHUVUC(
    ...
    MaKhuVuc     VARCHAR2(10) UNIQUE NOT NULL,
    ...
    CONSTRAINT CK_SCKV_KV CHECK(SucChuaKV >= 0)
);

CREATE TABLE GHENGOI(
    MaGheNum     NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    MaGhe        VARCHAR2(10) UNIQUE NOT NULL,
    SoHang       NUMBER(5),
    SoGhe        NUMBER(5),
    ToaDo        VARCHAR2(50),
    MaKhuVucNum  NUMBER,
...
CREATE TABLE NGHESI(
    ...
    MaNgheSi     VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE MAUCHINHSACHHOANTIEN(
    ...
    MaChinhSachHT    VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE QUYTACHOANTIEN(
    ...
    MaQuyTac         VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE DANHMUCTIENICH (
    ...
    MaTienIch       VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE HANGVE (
    ...
    MaHangVe        VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE VE (
    ...
    MaVe            VARCHAR2(10) UNIQUE NOT NULL,
    ...
    CONSTRAINT FK_VE_SV FOREIGN KEY (MaSoatVeNum) REFERENCES NHATKYSOATVE(MaSoatVeNum),
...
CREATE TABLE NGUOIDUNG (
    ...
    MaNguoiDung    VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE TAIKHOAN (
    ...
    MaTaiKhoan     VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE CHUCNANG (
    ...
    MaChucNang     VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE PHAMVIQUYEN (
    ...
    MaPhamVi       VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE NHOMQUYEN (
    ...
    MaNhomQuyen    VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE HANGCHO (
    ...
    MaHangCho        VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE NHATOCHUC (
    ...
    MaNhaToChuc      VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE DONMUA(
    ...
    MaDonMua            VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE CHIENDICHKHUYENMAI (
    ...
    MaChienDich      VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE MAGIAMGIA (
    MaGiamGia        VARCHAR2(50) PRIMARY KEY NOT NULL,
...
CREATE TABLE YEUCAUHOTRO (
    ...
    MaYeuCau         VARCHAR2(10) UNIQUE NOT NULL,
...
CREATE TABLE GIAODICH (
    ...
    MaGiaoDich         VARCHAR2(30) UNIQUE NOT NULL,
    ...
    CONSTRAINT CK_ST_GD CHECK(SoTien >= 0)
);

CREATE TABLE GIAODICHBANLAI (
    MaGiaoDichNum    NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    MaGiaoDich       VARCHAR2(20) UNIQUE NOT NULL,
    GiaNiemYet       NUMBER(15, 2) NOT NULL,
    GiaChot          NUMBER(15, 2),
    PhiSan           NUMBER(15, 2),
...
CREATE TABLE NHATKYHETHONG (
    ...
    MaNhatKyHT     VARCHAR2(20) UNIQUE NOT NULL,
...
CREATE TABLE NHATKYTHONGBAO (
    ...
    MaThongBao     VARCHAR2(20) UNIQUE NOT NULL,
    KenhGui        VARCHAR2(20),
    NoiDung        CLOB,
...
CREATE TABLE NHATKYDANGNHAP (
    ...
    MaLog          VARCHAR2(20) UNIQUE NOT NULL,
    ...
    CONSTRAINT CHK_TT_DN CHECK (TrangThai IN ('Thành công', 'Thất bại'))
);